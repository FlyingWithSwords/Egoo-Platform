    ...
    var miniTheme = {
        ...
        buildBgColorHtml: function (options) {
            ...
            $.each(bgColorConfig, function (key, val) {
                if (key === bgcolorId) {
                    html += '<li class="layui-this" style="border-radius:3px;" data-select-bgcolor="' + key + '">\n';
                } else {
                    html += '<li style="border-radius:3px;" data-select-bgcolor="' + key + '">\n';
                }
                html += '<a href="javascript:;" data-skin="skin-blue" style="border-radius:9px;" class="clearfix full-opacity-hover">\n' +
                    '<div><span style="border-top-left-radius: 3px; display:block; width: 20%; float: left; height: 12px; background: ' + val.headerLogoBg + ';"></span><span style="border-top-right-radius: 3px; display:block; width: 80%; float: left; height: 12px; background: ' + val.headerRightBg + ';"></span></div>\n' +
                    '<div><span style="border-bottom-left-radius: 3px; display:block; width: 20%; float: left; height: 40px; background: ' + val.leftMenuBg + ';"></span><span style="border-bottom-right-radius: 3px; display:block; width: 80%; float: left; height: 40px; background: #ffffff;"></span></div>\n' +
                    '</a>\n' +
                    '</li>';
            });
            return html;
        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 乐器商品管理系统 V1.0</a>\n' +
                    '<a class="more-menu-item"><i class="layui-icon layui-icon-user" style="font-size: 16px;"></i> FWSSYS</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
